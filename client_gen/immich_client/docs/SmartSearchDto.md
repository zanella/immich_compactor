...
**language** | Option<**String**> | Search language code | [optional]
...
**query** | Option<**String**> | Natural language search query | [optional]
**query_asset_id** | Option<**uuid::Uuid**> | Asset ID to use as search reference | [optional]
