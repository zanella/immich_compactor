...
**checksum** | Option<**String**> | Filter by file checksum | [optional]
...
**description** | Option<**String**> | Filter by description text | [optional]
**encoded_video_path** | Option<**String**> | Filter by encoded video file path | [optional]
**id** | Option<**uuid::Uuid**> | Filter by asset ID | [optional]
...
**original_file_name** | Option<**String**> | Filter by original file name | [optional]
**original_path** | Option<**String**> | Filter by original file path | [optional]
**page** | Option<**i32**> | Page number | [optional]
**person_ids** | Option<**Vec<uuid::Uuid>**> | Filter by person IDs | [optional]
**preview_path** | Option<**String**> | Filter by preview file path | [optional]
...
**thumbnail_path** | Option<**String**> | Filter by thumbnail file path | [optional]
